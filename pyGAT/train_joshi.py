...
filedir = "./joshi_results/" + args.gene.lower() + "/" + str(args.lam) + "." + str(args.lr) + "." + str(args.patience)
print ("*****\n" + filedir + "\n*****\n")
os.mkdir(filedir)
...
# Load data
adj, features, labels, idx_train, idx_val, idx_test, neighbor_genes = load_joshi_data(args.gene)
